# Rotina simples do TrigoPDV

## Abertura

1. Ligue computador, leitor e impressora.
2. Abra o TrigoPDV e entre com seu próprio usuário.
3. Abra o caixa informando o dinheiro contado na gaveta.
4. Confira o valor em caixa mostrado pelo sistema.

## Venda

1. Leia o código ou procure o produto.
2. Confira nome, quantidade, preço e subtotal na tela.
3. Para produto por peso, informe quilogramas com até três casas decimais.
...
o cadastro manual autorizado.

## Dinheiro e fechamento

- registre toda entrada ou retirada com motivo;
- não retire dinheiro sem lançar no sistema;
- no fechamento, conte a gaveta e informe o valor contado;
- confira diferença e justificativa antes de confirmar;
